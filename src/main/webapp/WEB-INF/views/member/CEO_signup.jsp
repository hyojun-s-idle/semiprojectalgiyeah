...
<body>
        ...
        <div class="content">
            <form action="#">
                <fieldset>
                    <div class="signup-box" id="signup-box">
                        ...
                        <div class="id-area">
                            <h3>아이디</h3>
                            <input type="text" id="id-input" placeholder="4자~20자리">
                        </div>
                        <div class="pw-area">
                            <h3>비밀번호</h3>
                            <input type="text" id="pw-input" placeholder="8~16자리">
                        </div>
                        <div class="pw-check-area">
                            <h3>비밀번호 확인</h3>
                            <input type="text" id="pwd-input" placeholder="8~16자리">
                        </div>
                        <div class="name-area">
                            <h3>이름</h3>
                        ...
                        <div class="email-area">
                            <h3>이메일</h3>
                            <input type="text" id="email-input" placeholder="alba@alba.co.kr">
                        </div>
                        <div class="phone-area">
                            <h3>전화번호</h3>
                            <input type="text" id="phone-input" placeholder="-빼고 입력해주세요">
                        </div>
            ...
            <div class="signup-box2" id="signup-box2">
                <h1>사장님 회원가입</h1>
                        ...
                        <div class="job-area">
                            <h3>직종</h3>
                            <select name="job" class="select" id="job-select">
                                <option value="1">외식/음료</option>
                                <option value="2">매장 관리</option>
                                <option value="3">서비스</option>
                                <option value="4">사무직</option>
                                <option value="5">운전/배달</option>
                        ...
                        <div class="question-area">
                            ...
                            <h3>질문 * <i id="ic" class="fa-solid fa-question" style="color: #f60909;"></i></h3>
                            <div id="q">아이디 / 비밀번호 분실시 사용됩니다</div>
                            <select name="question" class="select" id="question-select">
                        ...
                        <div class="email-area">
                            ...
                            <div class="do">1.이 약관의 내용은 서비스 화면에 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력을 발생합니다.
                                ...
                                학회는 서비스 제공과 관련해서 알고 있는 회원의 신상정보를 본인의 승낙 없이 제 3자에게 누설, 배포하지 않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 정보통신윤리위원회의 요청이 있는 경우 또는 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우에는 그러하지 않습니다.
                                
                                 
                                
                                제 10 조 (회원 ID와 P.W 관리에 대한 의무)
                                
                                회원 ID와 P.W에 관한 모든 관리책임은 회원에게 있습니다. 회원에게 부여된 ID와 P.W의 관리소홀, 부정사용에 의하여 발생하는 모든 결과에 대한 책임은 회원에게 있습니다. 자신의 ID와 P.W가 부정하게 사용된 경우 회원은 반드시 학회에 그 사실을 통보해야 합니다.
                                ...
                                4.회원은 학회의 사전승낙 없이는 서비스를 이용하여 영업활동을 할 수 없으며, 영업활동의 결과와 회원이 약관에 위반한 영업활동을 이용하여 발생한 결과에 대하여 학회는 책임을 지지 않습니다.
                                ...
                                서비스의 이용은 학회의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간을 원칙으로 합니다. 다만 정기점검 등의 필요로 학회가 정한 날이나 시간은 그러하지 않습니다. 학회는 서비스를 일정범위로 분할하여 각 범위별로 이용가능시간을 별도로 정할 수 있으며 이 경우 그 내용을 사전에 공지합니다.
                                ...
                                2.학회는 국가비상사태, 정전, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 때에는 서비스의 전부 또는 일부를 제한하거나 정지할 수 있습니다.
                                ...
                                회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 온라인(메일)을 통해 학회에 해지신청을 하여야 합니다. 학회는 회원이 다음 각 호에 해당하는 행위를 하였을 경우 사전통지 없이 이용계약을 해지하거나 또는 기간을 정하여 서비스 이용을 중지할 수 있습니다.
                        ...
                        <button id="signup-com">SIGN UP</button>
            </div>
        </fieldset>
    </form>
        </div>
    ...
    <script>
        document.getElementById("next").addEventListener("click", function(){
            ...
            document.getElementById("signup-box2").style.display ="block";   
