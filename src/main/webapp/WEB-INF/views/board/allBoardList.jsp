                                    ...
                                    <c:otherwise>
                                        <c:forEach var="board" items="${boardList}">
                                            <li>
                                                    ...
                                                    <a href="${contextPath}/board/boardList/detail?type=${param.type}&cp=${pagination.currentPage}&no=${board.boardNo}" class="post-suround">
                                                    ...
                                                    <div class="account-div">
                                                        <div class="account-div-name">
                                                            ...
                                                            <div class="account-name">${board.memberNickname}</div>
                                                        </div>
